...
cmdInputs = {
	"-if": {"name": "Input Folder", "variable": ["./input/"], "active": True, "tooltips": "Select a folder for input files"},
    '-fn': {"name": "File Name", "variable": [[]], "active": True, "tooltips": "Select a the folder"},
	...
	'-bt':{"name":"Black Hat Contrasting","types":['int'],"names":['kernel'],"variable":[50],"active":False,"tooltips":"Performs Black Hat and Top Hate Contrasting, kernel size can be set"},
